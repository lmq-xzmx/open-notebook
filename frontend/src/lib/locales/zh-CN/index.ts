export const zhCN = {
  ...
  apiKeys: {
    ...
    edgeTTSAvailable: "可用",
    edgeTTSUnavailable: "不可用",
    edgeTTSNotInstalled: "edge-tts 未安装，请运行: uv pip install edge-tts",
    edgeBaseUrlHint: "Edge TTS 使用微软 Azure 认知服务，无需 Base URL",
  },
  setupBanner: {
    encryptionRequired: "未配置加密密钥",
